...
class PurchaseWindow(QDialog):
    ...
    def init_ui(self):
        self.setWindowTitle("Purchase transaction")
    ...
    def populate_table(self):
        ...
        try:
            self.cursor.execute("SELECT * FROM itemslist4")
            ...
            # Set table headers
            self.table.setHorizontalHeaderLabels(["Name","Item ID", "Item Name", "Price", "Quantity", "Total Cost"])
